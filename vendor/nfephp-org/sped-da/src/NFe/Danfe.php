...
class Danfe extends Common
{
    ...
    protected function pCabecalhoDANFE($x = 0, $y = 0, $pag = '1', $totPag = '1')
    {
        ...
        if (is_file($this->logomarca)) {
            ...
            $logoWmm = 78;//($logoInfo[0]/72)*25.4;
            //altura da imagem em mm
            $logoHmm = 30; //($logoInfo[1]/72)*25.4;
            if ($this->logoAlign=='L') {
                $nImgW = round($w/3, 0);
            ...
            $this->pdf->Image($this->logomarca, 7, 7, $logoWmm, $logoHmm, 'jpeg');
        } else {
            $x1 = $x;
            $y1 = round($h/3+$y, 0);
            $tw = $w;
    ...
    protected function pRodape($x, $y)
    {
        ...
        $texto = "Danfe gerada pelo SisHBR 2.0 www.hbr.ind.br";
        $this->pTextBox($x, $y, $this->wPrint, 0, $texto, $aFont, 'T', 'R', false, 'http://www.hbr.ind.br');
    }
